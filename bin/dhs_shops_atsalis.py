...
laptops.append("9033.55957,27.7806,25019.179688")
laptops.append("9034.425781,27.931,25018.576172")
laptops.append("9035.391602,28.0805,25017.611328")
laptops.append("8752.132813,0.438755,25163.0273438")
...
this addAction[
	"Heli Garage",
	{
		...
		life_garage_sp = "dhs_heli_spawn_atsalis_001";
	}
];
...
this addAction[
	localize"STR_Garage_Title",
	{
		...
		disableSerialization;
		ctrlSetText[2802,"Fetching Vehicles...."];
		life_garage_sp = "dhs_vehicle_spawn_atsalis_001";
	}
];
...
this addAction[
	...
	["civ_car",civilian,"dhs_vehicle_spawn_atsalis_001","civ","Bruce's New & Used Auto's"]
];

this addAction[
	localize"STR_MAR_Truck_Shop",
	life_fnc_vehicleShopMenu,
	["civ_truck",civilian,"dhs_vehicle_spawn_atsalis_002","civ","Bruce's New & Used Trucks"]
];

this addAction[
	localize"STR_MAR_Helicopter_Shop",
	life_fnc_vehicleShopMenu,
	["civ_air",civilian,["dhs_heli_spawn_atsalis_001","dhs_heli_spawn_atsalis_002"],"civ","Carl's Airial Auto's"]
];
...
this addAction[
	...
	life_fnc_vehicleShopMenu,
	["reb_car",civilian,["dhs_vehicle_spawn_atsalis_001","dhs_vehicle_spawn_atsalis_002"],"reb","Rebel Motorpool - DHS Base"],
	0,
	false,
	false,
	"",
...
shops = "%s;%s;%s;%s" % (shop_script, dhs_shop_001, dhs_shop_002, dhs_shop_003)
...
if __name__ == "__main__":
	with open(sys.argv[1], "r") as file_reader:
		for line in file_reader:
			if line.find("Land_Laptop_unfolded_F") > 0:
				for laptop in laptops:
					if line.find(laptop) > 0:
						line = line.replace('this enableSimulation false;this allowDamage false;', 'this enableSimulation false;this allowDamage false;%s;' % shops.replace('"', '""'))
