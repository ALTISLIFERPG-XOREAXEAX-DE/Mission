/*
*
* DO NOT EDIT THIS FILE IN Altis_Life.Altis/Config_vItems.hpp
*
* EDIT THE TEMPLATE IN Mission/templates/Config/vItems.hpp
*
*/
...
class VirtualShops {
    ...
    class cop {
        ...
        license = "";
        level[] = { "", "", -1, "" };
        items[] = { "donuts", "coffee", "zipties", "lockpick", "spikeStrip", "waterBottle", "rabbit", "apple", "redgull", "fuelFull", "defusekit" };
    };
...
class VirtualItems {
	...
	//
	// this item must NEVER be showing up in anything other than the admin shop
	//
	class money {
        variable = "money";
    ...
    class heroin_processed {
        ...
        sellPrice = %%%HEROIN_PROCESSED_SELLPRICE%%%; // HEROIN_PROCESSED_SELLPRICE
        illegal = true;
        edible = -1;
